...
`,y=s=>{const e=s.username.value;if(!e||!e.trim())return window.alert("이름을 입력해주세요.");i.setUserInfo({username:e,email:"",bio:""})},w=s=>{const e=s.username.value,r=s.email.value,o=s.bio.value;return i.setUserInfo({username:e,email:r,bio:o}),alert("alert")};export{p as B,v as E,h as L,g as M,x as P,w as a,y as h,i as u};
