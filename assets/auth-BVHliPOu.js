(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const l of t)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function r(t){const l={};return t.integrity&&(l.integrity=t.integrity),t.referrerPolicy&&(l.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?l.credentials="include":t.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(t){if(t.ep)return;t.ep=!0;const l=r(t);fetch(t.href,l)}})();const n="user",p="";let d=null;const m=()=>{if(d)return d;const s={userInfo:JSON.parse(localStorage.getItem(n)),setUserInfo(e){const r=this.userInfo;if(!r)return this.userInfo=e,localStorage.setItem(n,JSON.stringify(e));const{username:o,email:t,bio:l}=e,a={...r,...r.username!==o&&{username:o},...r.email!==t&&{email:t},...r.bio!==l&&{bio:l}};this.userInfo=a,localStorage.setItem(n,JSON.stringify(a))},getUserInfo(){return this.userInfo},loggedIn(){return!!this.userInfo},logout(){this.userInfo=null,localStorage.removeItem(n)}};return d=s,s},i=m(),c=()=>{const s=i.loggedIn(),e=location.href.split("/").length,r=location.href.split("/")[e-1];return`
  ...
  <div class="bg-gray-100 min-h-screen flex justify-center">
    <div class="max-w-md w-full">
      ...
      <main class="p-4">
        ...
        <div class="space-y-4">${b.map(s=>f(s))}</div>
      </main>
      ${u}
    </div>
  </div>
...
`,y=s=>{const e=s.username.value;if(!e||!e.trim())return window.alert("이름을 입력해주세요.");i.setUserInfo({username:e,email:"",bio:""})},w=s=>{const e=s.username.value,r=s.email.value,o=s.bio.value;i.setUserInfo({username:e,email:r,bio:o}),alert("프로필이 업데이트 되었어요!")};export{p as B,v as E,h as L,g as M,x as P,w as a,y as h,i as u};
